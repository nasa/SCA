...
**
**  Filename:
**    $Id: common_types.h 1.1 2015/03/10 13:08:53EDT czogby Exp  $
**
...
**
**
**  $Date: 2015/03/10 13:08:53EDT $
**  $Revision: 1.1 $
**  $Log: common_types.h  $
**  Revision 1.1 2015/03/10 13:08:53EDT czogby 
**  Initial revision
**  Member added to project c:/MKSDATA/MKS-REPOSITORY/CFS-REPOSITORY/sca/fsw/unit_test/project.pj
**  Revision 1.1 2011/05/16 15:41:44EDT sslegel 
**  Initial revision
**  Member added to project c:/MKSDATA/MKS-REPOSITORY/FSW-TOOLS-REPOSITORY/ut-assert/example/project.pj
